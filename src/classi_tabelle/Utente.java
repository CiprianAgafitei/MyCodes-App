...
public class Utente {
	...
	public Utente(int matricola, String nome, String cognome, String username, String password, String tipologia, String classe, String email) {
		super();
	...
	public String toString() {
		return "Utenti [matricola=" + matricola + ", nome=" + nome + ", cognome=" + cognome + ", username=" + username
				+ ", password=" + password + ", tipologia=" + tipologia + ", classe=" + classe + ", email="
				+ email + "]";
	}
