...
public class VisualizzazioneVerifica implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {		
		verifica = StudentiVotiController.getTest();
	...
	private void showAllHboxes() {
		for(int i = 0; i < elenco_hbox.size(); i++) {
			...
			elenco_hbox.get(i).setStyle("-fx-background-color: transparent;");
	...
	public void pulsanteTermina() {
		try {
			...
			ritornoPaginaAdmin = (StackPane) FXMLLoader.load(getClass().getResource("/studenti_voti/StudentiVoti.fxml"));
			...
			Logger.getLogger(VisualizzazioneVerifica.class.getName()).log(Level.SEVERE, null, e);
		}
	}
